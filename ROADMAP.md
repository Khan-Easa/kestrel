...
- **Phase 7 — Observability & Management** 🚧 *(in progress — design-lock pass complete 2026-05-23)*: Prometheus metrics, request-ID tracing, PostgreSQL audit log, API-key management CLI, per-key rate limits, admin endpoints. Sliced into 7 substeps per `DECISIONS.md` `7-scope`.
